...
1. Sign in to the AWS Management Console for AWS DeepLens at [AWS Managment Console](https://console.aws.amazon.com/deeplens/home?region=us-east-1#firstrun" target="_blank).
